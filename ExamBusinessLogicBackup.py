...
class Ui_ExamWindow(object):
    ...
    def retranslateUi(self, ExamWindow):
        ...
        self.Label_Note.setText(_translate("ExamWindow",
                                           "<html><head/><body><p>Note:</p><p>The Exam Consists </p><p>Of Only 5 Questions.</p></body></html>"))
    ...
    def StartQuiz(self):
        ...
        cursor = conn.cursor()
        m = cursor.execute("SELECT * FROM Images ORDER BY RANDOM () LIMIT 1")
        for x in m:
            rec_data = x[1]
            ActualAnswer = x[2]
        ...
        path = QPixmap("C:\\Users\\user\\PYTHON UI\\perjectnew\\fruit.jpg")
        path2 = path.scaled(171, 121)
        
        #try lang
        self.Label_WelcomeUser.setText(ActualAnswer)
